...
-- IMPORTANT
--USE [p-ause-ps-sql-db-covid-testtracker-01_Copy_Release48_01_08_03_2022];  -- <<<<<<<<<<<< CHANGE THIS VALUE to Schema you want to dump
;
...
AS (
  ...
  GROUP BY bt.TABLE_SCHEMA,bt.SchemaName, bt.table_name, tut.column_name
)
...
SELECT distinct  md.schema_nm,de.TABLE_SCHEMA, md.table_nm, md.obj_typ, md.ord_pos
...
ORDER BY de.TABLE_SCHEMA, table_nm, ord_pos
