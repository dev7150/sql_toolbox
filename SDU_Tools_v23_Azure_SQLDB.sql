...
-- Version 23.0 Azure SQL DB Edition
--==================================================================================
--
...
-- 23.0                   Nil
--
-- 22.0                   Corrected comments in WeekdayAcrossYears
--                        DayNumberOfMonth now inlineable and has large performance 
--                        improvement (thanks Jeff Moden)
--                        Case sensitivity issue with StripDiacritics corrected
--                        Fixed some case sensitivity issues for DB projects
--
...
--==================================================================================
-- 23.0                   DateDimensionColumns now has StartOfWeek and EndOfWeek
--                        DateDimensionPeriodColumns now has IsSameWeek, DayOffset, MonthOffset, and WeekOffset
-- 22.0                   DateDimensionColumns now has DayOfWeek
...
--                        CalculateAge performance improvements and handles negatives
...
--
-- FilePathToFileExtension         Returns the file extension from within a file path
--                                 Refer to this video: https://youtu.be/ZtIrR-o319s
--
-- FilePathToFileName              Returns the file name from within a file path
--                                 Refer to this video: https://youtu.be/ZtIrR-o319s
--
-- FilePathToFolderPath            Returns the folder path from within a file path
--                                 Refer to this video: https://youtu.be/ZtIrR-o319s
--
...
--
-- CalculateAgeInMonths            Calculates the age in months of anything based on 
--                                 starting date (such as date of birth) and 
--                                 ending date (such as today)
...
--                                 Refer to this video: https://youtu.be/tGplVv-G3E4
--
-- ExcelSerialToDateTime           Converts an Excel serial value (date time) to a
--                                 SQL Server datetime
--                                 Refer to this video: https://youtu.be/hxmGtKjkcwk
--
-- DateTimeToExcelSerial           Converts a SQL Server datetime to an Excel serial
--                                 (datetime)
--                                 Refer to this video: https://youtu.be/hxmGtKjkcwk
--
...
--
-- LastSQLServerRestart             Not appropriate for the Azure SQL DB version
--
...
--      
-- ListConstraintsWithSystemNames   Lists all constraints that have not been explicitly named
--                                  Azure SQL DB version is ListConstraintsWithSystemNamesInCurrentDatabase
...
--     
-- ListUntrustedCheckConstraints    Lists check constraints declared but not trusted
--                                  Azure SQL DB version is ListUntrustedCheckConstraintsInCurrentDatabase
--                                  Refer to this video: https://youtu.be/d2-8ZMeaB0A
--
-- ListUntrustedForeignKeys         Lists foreign keys declared but not trusted
--                                  Azure SQL DB version is ListUntrustedForeignKeysInCurrentDatabase
--                                  Refer to this video: https://youtu.be/d2-8ZMeaB0A
--
...
--                                  Refer to this video: https://youtu.be/VuKJEtZ44WY
--
-- Languages                        Table of the world's languages
--                                  Refer to this video: https://youtu.be/itf_2Zlfuos
--
...
BEGIN -- drop all existing objects in the SDU_Tools schema
    ...
    DECLARE @IsVersionWithExternalTables bit = 1; -- All Azure SQL DB
...
*/
    RETURN (CAST(CONVERT(char(8), @CalculationDate, 112) AS int) - CAST(CONVERT(char(8), @StartingDate, 112) AS int)) / 10000;
END;
GO
...
RETURN SELECT @Date AS [Date],
              ...
              DATEADD(day, 1 - DATEPART(weekday, @Date), @Date) AS StartOfWeekDate,
              DATEADD(day, 7 - DATEPART(weekday, @Date), @Date) AS EndOfWeekDate;
GO
...
FROM (VALUES (N'Windows', N'10.0', N'Windows 11/Windows 10/Windows Server 2016/Windows Server 2019/Windows Server 2022'),
             ...
             (N'Windows', N'5.0', N'Windows 2000'),
             (N'Windows', N'4.9', N'Windows Me'),
             (N'Windows', N'4.1', N'Windows 98'),
             (N'Windows', N'4.0', N'Windows 95/Windows NT 4.0'),
             (N'Windows', N'3.51', N'Windows NT 3.51'),
             (N'Windows', N'3.5', N'Windows NT 3.5'),
             (N'Windows', N'3.1', N'Windows NT 3.1')) AS OS(OS_Family, OS_Version, OS_Name);
GO
...
FROM (VALUES ('SQL Server 2008','RTM',NULL,10,0,1600,'20080806',NULL,NULL),
             ...
             ('SQL Server 2016','SP3',NULL,13,0,6300,'20210915','5003279','4046056,4480630,4493329,4500511,4506023,4515772,4526524,4530907,4531386,4536005,4537868,4541132,4541303,4551720,4578579,5003596,5003937,5004059,5004466,5005453,5005686,5005687,5005689'),
             ...
             ('SQL Server 2017','RTM','CU25',14,0,3401,'20210713','5003830','5004466,5004560,5004646,5004766,5004767'),
             ('SQL Server 2017','RTM','CU26',14,0,3411,'20210915','5005226','4039592,4530907,5004573,5004734,5004750,5004936,5005788,5006029'),
             ('SQL Server 2017','RTM','CU27',14,0,3421,'20211029','5006944','5007039,5007158,5007381'),
             ('SQL Server 2017','RTM','CU28',14,0,3430,'20220114','5008084',''),
             ('SQL Server 2017','RTM','CU29',14,0,3436,'20220401','5010786','5008296,5013181,5013207'),
             ('SQL Server 2017','RTM','CU30',14,0,3451,'20220713','5013756','5014047'),
             ('SQL Server 2017','RTM','CU31',14,0,3456,'20220920','5016884','5008184,5017551,5017788,5018050,5018231'),
             ...
             ('SQL Server 2019','RTM','CU11',15,0,4138,'20210611','5003249', '4023170,4535851,5003342,5003525,5003589,5003596,5003750,5003869,5003870,5003937'),
             ('SQL Server 2019','RTM','CU12',15,0,4153,'20210807','5004524', '5001045,5004733,5004734,5004936,5004750,5004560,5004573,5004649,5005321'),
             ('SQL Server 2019','RTM','CU13',15,0,4178,'20211006','5005679', '4530907,5005788,5006359,5006632,5006665'),
             ('SQL Server 2019','RTM','CU14',15,0,4178,'20211123','5007182', '4538688,5004936,5007794,5007719,5007744,5007842,5008107,5008114,5008184,5008296'),
             ('SQL Server 2019','RTM','CU15',15,0,4198,'20220128','5008996', '5008647,5008648,5009753,5010234,5010246,5010555,5010653'),
             ('SQL Server 2019','RTM','CU16',15,0,4223,'20220420','5011644', '4530955,4538581,4538688,5011644,5012964,5014047,5014136,5014137'),
             ('SQL Server 2019','RTM','CU17',15,0,4249,'20220811','5016394', '5013181,5016729,5016780,5017009,5017100'),
             ('SQL Server 2019','RTM','CU18',15,0,4261,'20220928','5017593', '5017551,5017718,5018050,5019307')
             ) 
...
-- Return:        date
-- NOTE: Updated for performance and adapted from a concept submitted by Jeff Moden. (Thanks Jeff)
-- Refer to this video: https://youtu.be/BeVXs-J4soo
--
-- Test examples: 
/*
...
*/
    ...
    (
        SELECT NumberedDate  
        FROM (VALUES (DATEADD(day, DATEDIFF(day, 7, DATEFROMPARTS(@Year, @Month, 1)) / 7 * 7, 6) + @DayOfWeek - 1)) 
             AS sd(SameDayOfFirstWeek)
        CROSS APPLY (VALUES (sd.SameDayOfFirstWeek + (@DayNumber - CASE WHEN sd.SameDayOfFirstWeek < DATEFROMPARTS(@Year, @Month, 1)
                                                                        THEN 0 
                                                                        ELSE 1 
                                                                   END) * 7)) AS nd(NumberedDate)
        WHERE MONTH(NumberedDate) = @Month);
END;
GO
...
SELECT CASE WHEN @Date = @Today 
       ...
       CASE WHEN @Date BETWEEN DATEADD(day, 1 - DATEPART(weekday, @Date), @Date)  
                       AND DATEADD(day, 7 - DATEPART(weekday, @Date), @Date)
            THEN CAST(1 AS bit)
            ELSE CAST(0 AS bit)
       END AS IsSameWeek,
       DATEDIFF(day, @Today, @Date) AS DayOffset,
       DATEDIFF(month, DATEADD(day, 1, EOMONTH(@Today, -1)), DATEFROMPARTS(YEAR(@Date), MONTH(@Date), 1)) AS MonthOffset,
       DATEDIFF(week, DATEADD(day, 1 - DATEPART(weekday, @Today), @Today), DATEADD(day, 1 - DATEPART(weekday, @Date), @Date)) AS WeekOffset
...
CREATE VIEW SDU_Tools.Languages
AS

-- Function:      Returns all the world's languages
-- Parameters:    Nil
-- Action:        Returns all the world's languages
--                based on ISO 639-1
-- Return:        View of all languages
-- Refer to this video: https://youtu.be/itf_2Zlfuos
--
-- Test examples: 
/*

SELECT * FROM  SDU_Tools.Languages;

*/
SELECT FamilyName, LanguageName, NativeLanguageName, ISO2CharacterCode, ISO3CharacterCode
FROM 
(
    VALUES (N'Northwest Caucasian',N'Abkhazian',N'аҧсуа бызшәа',N'ab',N'abk'),
           (N'Afro-Asiatic',N'Afar',N'Afaraf',N'aa',N'aar'),
           (N'Indo-European',N'Afrikaans',N'Afrikaans',N'af',N'afr'),
           (N'Niger–Congo',N'Akan',N'Akan',N'ak',N'aka'),
           (N'Indo-European',N'Albanian',N'Shqip',N'sq',N'alb'),
           (N'Afro-Asiatic',N'Amharic',N'አማርኛ',N'am',N'amh'),
           (N'Afro-Asiatic',N'Arabic',N'العربية',N'ar',N'ara'),
           (N'Indo-European',N'Aragonese',N'aragonés',N'an',N'arg'),
           (N'Indo-European',N'Armenian',N'Հայերեն',N'hy',N'arm'),
           (N'Indo-European',N'Assamese',N'অসমীয়া',N'as',N'asm'),
           (N'Northeast Caucasian',N'Avaric',N'авар мацӀ',N'av',N'ava'),
           (N'Indo-European',N'Avestan',N'avesta',N'ae',N'ave'),
           (N'Aymaran',N'Aymara',N'aymar aru',N'ay',N'aym'),
           (N'Turkic',N'Azerbaijani',N'تۆرکجه',N'az',N'aze'),
           (N'Niger–Congo',N'Bambara',N'bamanankan',N'bm',N'bam'),
           (N'Turkic',N'Bashkir',N'башҡорт теле',N'ba',N'bak'),
           (N'Language isolate',N'Basque',N'euskara',N'eu',N'baq'),
           (N'Indo-European',N'Belarusian',N'беларуская мова',N'be',N'bel'),
           (N'Indo-European',N'Bengali',N'বাংলা',N'bn',N'ben'),
           (N'Creole',N'Bislama',N'Bislama',N'bi',N'bis'),
           (N'Indo-European',N'Bosnian',N'bosanski jezik',N'bs',N'bos'),
           (N'Indo-European',N'Breton',N'brezhoneg',N'br',N'bre'),
           (N'Indo-European',N'Bulgarian',N'български език',N'bg',N'bul'),
           (N'Sino-Tibetan',N'Burmese',N'ဗမာစာ',N'my',N'bur'),
           (N'Indo-European',N'Catalan',N'català',N'ca',N'cat'),
           (N'Austronesian',N'Chamorro',N'Chamoru',N'ch',N'cha'),
           (N'Northeast Caucasian',N'Chechen',N'нохчийн мотт',N'ce',N'che'),
           (N'Niger–Congo',N'Chichewa',N'chiCheŵa',N'ny',N'nya'),
           (N'Sino-Tibetan',N'Chinese',N'中文',N'zh',N'chi'),
           (N'Turkic',N'Chuvash',N'чӑваш чӗлхи',N'cv',N'chv'),
           (N'Indo-European',N'Cornish',N'Kernewek',N'kw',N'cor'),
           (N'Indo-European',N'Corsican',N'corsu',N'co',N'cos'),
           (N'Algonquian',N'Cree',N'ᓀᐦᐃᔭᐍᐏᐣ',N'cr',N'cre'),
           (N'Indo-European',N'Croatian',N'hrvatski jezik',N'hr',N'hrv'),
           (N'Indo-European',N'Czech',N'čeština',N'cs',N'cze'),
           (N'Indo-European',N'Danish',N'dansk',N'da',N'dan'),
           (N'Indo-European',N'Divehi',N'ދިވެހި',N'dv',N'div'),
           (N'Indo-European',N'Dutch',N'Nederlands',N'nl',N'dut'),
           (N'Sino-Tibetan',N'Dzongkha',N'རྫོང་ཁ',N'dz',N'dzo'),
           (N'Indo-European',N'English',N'English',N'en',N'eng'),
           (N'Artificial',N'Esperanto',N'Esperanto',N'eo',N'epo'),
           (N'Uralic',N'Estonian',N'eesti',N'et',N'est'),
           (N'Niger–Congo',N'Ewe',N'Eʋegbe',N'ee',N'ewe'),
           (N'Indo-European',N'Faroese',N'føroyskt',N'fo',N'fao'),
           (N'Austronesian',N'Fijian',N'vosa Vakaviti',N'fj',N'fij'),
           (N'Uralic',N'Finnish',N'suomi',N'fi',N'fin'),
           (N'Indo-European',N'French',N'français',N'fr',N'fre'),
           (N'Niger–Congo',N'Fulah',N'Fulfulde',N'ff',N'ful'),
           (N'Indo-European',N'Galician',N'Galego',N'gl',N'glg'),
           (N'Kartvelian',N'Georgian',N'ქართული',N'ka',N'geo'),
           (N'Indo-European',N'German',N'Deutsch',N'de',N'ger'),
           (N'Indo-European',N'Greek',N'ελληνικά',N'el',N'gre'),
           (N'Tupian',N'Guarani',N'Avañe''ẽ',N'gn',N'grn'),
           (N'Indo-European',N'Gujarati',N'ગુજરાતી',N'gu',N'guj'),
           (N'Creole',N'Haitian',N'Kreyòl ayisyen',N'ht',N'hat'),
           (N'Afro-Asiatic',N'Hausa',N'(Hausa) هَوُسَ',N'ha',N'hau'),
           (N'Afro-Asiatic',N'Hebrew',N'עברית',N'he',N'heb'),
           (N'Niger–Congo',N'Herero',N'Otjiherero',N'hz',N'her'),
           (N'Indo-European',N'Hindi',N'हिन्दी, हिंदी',N'hi',N'hin'),
           (N'Austronesian',N'Hiri Motu',N'Hiri Motu',N'ho',N'hmo'),
           (N'Uralic',N'Hungarian',N'magyar',N'hu',N'hun'),
           (N'Artificial',N'Interlingua',N'Interlingua',N'ia',N'ina'),
           (N'Austronesian',N'Indonesian',N'Bahasa Indonesia',N'id',N'ind'),
           (N'Artificial',N'Interlingue',N'Interlingue',N'ie',N'ile'),
           (N'Indo-European',N'Irish',N'Gaeilge',N'ga',N'gle'),
           (N'Niger–Congo',N'Igbo',N'Asụsụ Igbo',N'ig',N'ibo'),
           (N'Eskimo–Aleut',N'Inupiaq',N'Iñupiaq',N'ik',N'ipk'),
           (N'Artificial',N'Ido',N'Ido',N'io',N'ido'),
           (N'Indo-European',N'Icelandic',N'Íslenska',N'is',N'ice'),
           (N'Indo-European',N'Italian',N'Italiano',N'it',N'ita'),
           (N'Eskimo–Aleut',N'Inuktitut',N'ᐃᓄᒃᑎᑐᑦ',N'iu',N'iku'),
           (N'Japonic',N'Japanese',N'日本語 (にほんご)',N'ja',N'jpn'),
           (N'Austronesian',N'Javanese',N'ꦧꦱꦗꦮ',N'jv',N'jav'),
           (N'Eskimo–Aleut',N'Kalaallisut',N'kalaallisut',N'kl',N'kal'),
           (N'Dravidian',N'Kannada',N'ಕನ್ನಡ',N'kn',N'kan'),
           (N'Nilo-Saharan',N'Kanuri',N'Kanuri',N'kr',N'kau'),
           (N'Indo-European',N'Kashmiri',N'कश्मीरी',N'ks',N'kas'),
           (N'Turkic',N'Kazakh',N'қазақ тілі',N'kk',N'kaz'),
           (N'Austroasiatic',N'Central Khmer',N'ខ្មែរ',N'km',N'khm'),
           (N'Niger–Congo',N'Kikuyu',N'Gĩkũyũ',N'ki',N'kik'),
           (N'Niger–Congo',N'Kinyarwanda',N'Ikinyarwanda',N'rw',N'kin'),
           (N'Turkic',N'Kirghiz',N'Кыргызча',N'ky',N'kir'),
           (N'Uralic',N'Komi',N'коми кыв',N'kv',N'kom'),
           (N'Niger–Congo',N'Kongo',N'Kikongo',N'kg',N'kon'),
           (N'Koreanic',N'Korean',N'한국어',N'ko',N'kor'),
           (N'Indo-European',N'Kurdish',N'کوردی‎',N'ku',N'kur'),
           (N'Niger–Congo',N'Kuanyama',N'Kuanyama',N'kj',N'kua'),
           (N'Indo-European',N'Latin',N'latine',N'la',N'lat'),
           (N'Indo-European',N'Luxembourgish',N'Lëtzebuergesch',N'lb',N'ltz'),
           (N'Niger–Congo',N'Ganda',N'Luganda',N'lg',N'lug'),
           (N'Indo-European',N'Limburgan',N'Limburgs',N'li',N'lim'),
           (N'Niger–Congo',N'Lingala',N'Lingála',N'ln',N'lin'),
           (N'Tai–Kadai',N'Lao',N'ພາສາລາວ',N'lo',N'lao'),
           (N'Indo-European',N'Lithuanian',N'lietuvių kalba',N'lt',N'lit'),
           (N'Niger–Congo',N'Luba-Katanga',N'Kiluba',N'lu',N'lub'),
           (N'Indo-European',N'Latvian',N'latviešu valoda',N'lv',N'lav'),
           (N'Indo-European',N'Manx',N'Gaelg',N'gv',N'glv'),
           (N'Indo-European',N'Macedonian',N'македонски јазик',N'mk',N'mac'),
           (N'Austronesian',N'Malagasy',N'fiteny malagasy',N'mg',N'mlg'),
           (N'Austronesian',N'Malay',N'بهاس ملايو‎',N'ms',N'may'),
           (N'Dravidian',N'Malayalam',N'മലയാളം',N'ml',N'mal'),
           (N'Afro-Asiatic',N'Maltese',N'Malti',N'mt',N'mlt'),
           (N'Austronesian',N'Maori',N'te reo Māori',N'mi',N'mao'),
           (N'Indo-European',N'Marathi',N'मराठी',N'mr',N'mar'),
           (N'Austronesian',N'Marshallese',N'Kajin M̧ajeļ',N'mh',N'mah'),
           (N'Mongolic',N'Mongolian',N'Монгол хэл',N'mn',N'mon'),
           (N'Austronesian',N'Nauru',N'Dorerin Naoero',N'na',N'nau'),
           (N'Dené–Yeniseian',N'Navajo',N'Diné bizaad',N'nv',N'nav'),
           (N'Niger–Congo',N'North Ndebele',N'isiNdebele',N'nd',N'nde'),
           (N'Indo-European',N'Nepali',N'नेपाली',N'ne',N'nep'),
           (N'Niger–Congo',N'Ndonga',N'Owambo',N'ng',N'ndo'),
           (N'Indo-European',N'Norwegian Bokmål',N'Norsk Bokmål',N'nb',N'nob'),
           (N'Indo-European',N'Norwegian Nynorsk',N'Norsk Nynorsk',N'nn',N'nno'),
           (N'Indo-European',N'Norwegian',N'Norsk',N'no',N'nor'),
           (N'Sino-Tibetan',N'Sichuan Yi',N'ꆈꌠ꒿ Nuosuhxop',N'ii',N'iii'),
           (N'Niger–Congo',N'South Ndebele',N'isiNdebele',N'nr',N'nbl'),
           (N'Indo-European',N'Occitan',N'occitan',N'oc',N'oci'),
           (N'Algonquian',N'Ojibwa',N'ᐊᓂᔑᓈᐯᒧᐎᓐ',N'oj',N'oji'),
           (N'Indo-European',N'Church Slavic',N'ѩзыкъ словѣньскъ',N'cu',N'chu'),
           (N'Afro-Asiatic',N'Oromo',N'Afaan Oromoo',N'om',N'orm'),
           (N'Indo-European',N'Oriya',N'ଓଡ଼ିଆ',N'or',N'ori'),
           (N'Indo-European',N'Ossetian',N'ирон æвзаг',N'os',N'oss'),
           (N'Indo-European',N'Punjabi',N'ਪੰਜਾਬੀ, پنجابی‎',N'pa',N'pan'),
           (N'Indo-European',N'Pali',N'पालि, पाळि',N'pi',N'pli'),
           (N'Indo-European',N'Persian',N'فارسی',N'fa',N'per'),
           (N'Indo-European',N'Polish',N'język polski',N'pl',N'pol'),
           (N'Indo-European',N'Pashto',N'پښتو',N'ps',N'pus'),
           (N'Indo-European',N'Portuguese',N'Português',N'pt',N'por'),
           (N'Quechuan',N'Quechua',N'Runa Simi',N'qu',N'que'),
           (N'Indo-European',N'Romansh',N'Rumantsch Grischun',N'rm',N'roh'),
           (N'Niger–Congo',N'Rundi',N'Ikirundi',N'rn',N'run'),
           (N'Indo-European',N'Romanian',N'Română',N'ro',N'rum'),
           (N'Indo-European',N'Russian',N'русский',N'ru',N'rus'),
           (N'Indo-European',N'Sanskrit',N'संस्कृतम्',N'sa',N'san'),
           (N'Indo-European',N'Sardinian',N'sardu',N'sc',N'srd'),
           (N'Indo-European',N'Sindhi',N'सिन्धी',N'sd',N'snd'),
           (N'Uralic',N'Northern Sami',N'Davvisámegiella',N'se',N'sme'),
           (N'Austronesian',N'Samoan',N'gagana fa''a Samoa',N'sm',N'smo'),
           (N'Creole',N'Sango',N'yângâ tî sängö',N'sg',N'sag'),
           (N'Indo-European',N'Serbian',N'српски језик',N'sr',N'srp'),
           (N'Indo-European',N'Gaelic',N'Gàidhlig',N'gd',N'gla'),
           (N'Niger–Congo',N'Shona',N'chiShona',N'sn',N'sna'),
           (N'Indo-European',N'Sinhalese',N'සිංහල',N'si',N'sin'),
           (N'Indo-European',N'Slovak',N'Slovenčina',N'sk',N'slo'),
           (N'Indo-European',N'Slovenian',N'Slovenski jezik',N'sl',N'slv'),
           (N'Afro-Asiatic',N'Somali',N'Soomaaliga',N'so',N'som'),
           (N'Niger–Congo',N'Southern Sotho',N'Sesotho',N'st',N'sot'),
           (N'Indo-European',N'Spanish',N'Español',N'es',N'spa'),
           (N'Austronesian',N'Sundanese',N'Basa Sunda',N'su',N'sun'),
           (N'Niger–Congo',N'Swahili',N'Kiswahili',N'sw',N'swa'),
           (N'Niger–Congo',N'Swati',N'SiSwati',N'ss',N'ssw'),
           (N'Indo-European',N'Swedish',N'Svenska',N'sv',N'swe'),
           (N'Dravidian',N'Tamil',N'தமிழ்',N'ta',N'tam'),
           (N'Dravidian',N'Telugu',N'తెలుగు',N'te',N'tel'),
           (N'Indo-European',N'Tajik',N'тоҷикӣ',N'tg',N'tgk'),
           (N'Tai–Kadai',N'Thai',N'ไทย',N'th',N'tha'),
           (N'Afro-Asiatic',N'Tigrinya',N'ትግርኛ',N'ti',N'tir'),
           (N'Sino-Tibetan',N'Tibetan',N'བོད་ཡིག',N'bo',N'tib'),
           (N'Turkic',N'Turkmen',N'Türkmen',N'tk',N'tuk'),
           (N'Austronesian',N'Tagalog',N'Wikang Tagalog',N'tl',N'tgl'),
           (N'Niger–Congo',N'Tswana',N'Setswana',N'tn',N'tsn'),
           (N'Austronesian',N'Tongan',N'Faka Tonga',N'to',N'ton'),
           (N'Turkic',N'Turkish',N'Türkçe',N'tr',N'tur'),
           (N'Niger–Congo',N'Tsonga',N'Xitsonga',N'ts',N'tso'),
           (N'Turkic',N'Tatar',N'татар теле',N'tt',N'tat'),
           (N'Niger–Congo',N'Twi',N'Twi',N'tw',N'twi'),
           (N'Austronesian',N'Tahitian',N'Reo Tahiti',N'ty',N'tah'),
           (N'Turkic',N'Uyghur',N'Uyghurche',N'ug',N'uig'),
           (N'Indo-European',N'Ukrainian',N'Українська',N'uk',N'ukr'),
           (N'Indo-European',N'Urdu',N'اردو',N'ur',N'urd'),
           (N'Turkic',N'Uzbek',N'Oʻzbek',N'uz',N'uzb'),
           (N'Niger–Congo',N'Venda',N'Tshivenḓa',N've',N'ven'),
           (N'Austroasiatic',N'Vietnamese',N'Tiếng Việt',N'vi',N'vie'),
           (N'Artificial',N'Volapük',N'Volapük',N'vo',N'vol'),
           (N'Indo-European',N'Walloon',N'Walon',N'wa',N'wln'),
           (N'Indo-European',N'Welsh',N'Cymraeg',N'cy',N'wel'),
           (N'Niger–Congo',N'Wolof',N'Wollof',N'wo',N'wol'),
           (N'Indo-European',N'Western Frisian',N'Frysk',N'fy',N'fry'),
           (N'Niger–Congo',N'Xhosa',N'isiXhosa',N'xh',N'xho'),
           (N'Indo-European',N'Yiddish',N'ייִדיש',N'yi',N'yid'),
           (N'Niger–Congo',N'Yoruba',N'Yorùbá',N'yo',N'yor'),
           (N'Tai–Kadai',N'Zhuang',N'Saɯ cueŋƅ',N'za',N'zha'),
           (N'Niger–Congo',N'Zulu',N'isiZulu',N'zu',N'zul')
) AS l(FamilyName, LanguageName, NativeLanguageName, ISO2CharacterCode, ISO3CharacterCode);
GO

------------------------------------------------------------------------------------

CREATE PROCEDURE SDU_Tools.ListConstraintsWithSystemNamesInCurrentDatabase
@SchemasToList nvarchar(max) = N'ALL',  -- N'ALL' for all
@TablesToList nvarchar(max) = N'ALL'    -- N'ALL' for all
AS
BEGIN
...
EXEC SDU_Tools.ListConstraintsWithSystemNamesInCurrentDatabase
     @SchemasToList = N'ALL', 
     @TablesToList = N'ALL'; 
...
(
    ...
    SELECT s.[name] AS SchemaName,
           ...
           dc.[name] AS ConstraintName,
           dc.type_desc AS ConstraintType
    FROM sys.key_constraints AS dc
    INNER JOIN sys.tables AS t
    ON t.object_id = dc.parent_object_id
    INNER JOIN sys.schemas AS s
    ON s.schema_id = dc.schema_id
...
CREATE FUNCTION SDU_Tools.FilePathToFileExtension
(
...
-- Function:      Extracts a file extension from a file path
-- Parameters:    @FilePath - nvarchar(max)
-- Action:        Extracts a file extension from a file path
-- Return:        nvarchar(max)
-- Refer to this video: https://youtu.be/ZtIrR-o319s
--
-- Test examples: 
...
SELECT SDU_Tools.FilePathToFileExtension(N'D:\SHARE\Rewards\A1023.png');
SELECT SDU_Tools.FilePathToFileExtension(N'//SHARE/Rewards/A1023.png');

*/
    RETURN (SELECT CASE WHEN CHARINDEX(N'.', REVERSE(@FilePath)) > 0
                        THEN RIGHT(@FilePath, CHARINDEX(N'.', REVERSE(@FilePath)) - 1)
                   END);
END;
GO
...
CREATE FUNCTION SDU_Tools.FilePathToFileName
(
    @FilePath nvarchar(max)
)
RETURNS nvarchar(max)
...
-- Function:      Extracts a filename from a file path
-- Parameters:    @FilePath - nvarchar(max)
-- Action:        Extracts a filename from a file path
-- Return:        nvarchar(max)
-- Refer to this video: https://youtu.be/ZtIrR-o319s
--
-- Test examples: 
...
SELECT SDU_Tools.FilePathToFileName(N'D:\SHARE\Rewards\A1023.png');
SELECT SDU_Tools.FilePathToFileName(N'//SHARE/Rewards/A1023.png');

*/
    RETURN (SELECT CASE WHEN CHARINDEX(N'\', REVERSE(REPLACE(@FilePath, N'/', N'\'))) > 0
                        THEN RIGHT(@FilePath, CHARINDEX(N'\', REVERSE(REPLACE(@FilePath, N'/', N'\'))) - 1)
                   END);
END;
GO
...
CREATE FUNCTION SDU_Tools.FilePathToFolderPath
(
    @FilePath nvarchar(max)
)
RETURNS nvarchar(max)
...
-- Function:      Extracts a folder path from a file path
-- Parameters:    @FilePath - nvarchar(max)
-- Action:        Extracts a folder path from a file path
-- Return:        nvarchar(max)
-- Refer to this video: https://youtu.be/ZtIrR-o319s
--
-- Test examples: 
...
SELECT SDU_Tools.FilePathToFolderPath(N'D:\SHARE\Rewards\A1023.png');
SELECT SDU_Tools.FilePathToFolderPath(N'//SHARE/Rewards/A1023.png');

*/
    RETURN (CASE WHEN CHARINDEX(N'\', REVERSE(REPLACE(@FilePath, N'/', N'\'))) > 0
                 THEN LEFT(@FilePath, LEN(@FilePath) - CHARINDEX(N'\', REVERSE(REPLACE(@FilePath, N'/', N'\'))))
            END);
END;
GO
...
CREATE PROCEDURE SDU_Tools.ListUntrustedCheckConstraintsInCurrentDatabase
@SchemasToInclude nvarchar(max) = N'ALL',  -- N'ALL' for all
@TablesToInclude nvarchar(max) = N'ALL'    -- N'ALL' for all
AS
BEGIN

-- Function:      List Untrusted Check Constraints
-- Parameters:    @SchemasToInclude nvarchar(max)  -> 'ALL' or comma-delimited list of schemas to list
--                @TablesToInclude nvarchar(max)   -> 'ALL' or comma-delimited list of tables to list
-- Action:        Lists untrusted check constraints. Ignores disabled constraints.
-- Return:        SchemaName, TableName, CheckConstraintName
-- Refer to this video: https://youtu.be/d2-8ZMeaB0A
--
-- Test examples: 
/*

EXEC SDU_Tools.ListUntrustedCheckConstraintsInCurrentDatabase
     @SchemasToInclude = N'ALL', 
     @TablesToInclude = N'ALL'; 
GO
...
SELECT ucc.SourceSchemaName AS SchemaName, 
...
CREATE PROCEDURE SDU_Tools.ListUntrustedForeignKeysInCurrentDatabase
@SchemasToInclude nvarchar(max) = N'ALL',  -- N'ALL' for all
@TablesToInclude nvarchar(max) = N'ALL'    -- N'ALL' for all
AS
BEGIN
...
--                @TablesToInclude nvarchar(max)   -> 'ALL' or comma-delimited list of tables to list
-- Action:        Tries to retrust untrusted foreign keys. Ignores disabled foreign keys.
-- Return:        SchemaName, TableName, ForeignKeyName
-- Refer to this video: https://youtu.be/d2-8ZMeaB0A
--
-- Test examples: 
/*

EXEC SDU_Tools.ListUntrustedForeignKeysInCurrentDatabase 
     @SchemasToInclude = N'ALL', 
     @TablesToInclude = N'ALL'; 
GO
...
SELECT ufk.SourceSchemaName AS SchemaName, 
...
*/
    RETURN CASE WHEN @ExcelSerialValue IS NOT NULL
                THEN DATEADD(second, 
                        (@ExcelSerialValue - FLOOR(@ExcelSerialValue)) * 60 * 60 * 24, -- seconds component
...
SELECT SDU_Tools.DateTimeToExcelSerial('2022-08-01 06:00:13.000');
...
*/
    RETURN CASE WHEN @ValueToConvert IS NOT NULL
                THEN CAST(DATEDIFF(day, '18991230', CAST(@ValueToConvert AS date)) AS float)
                     + CAST(DATEPART(hour, @ValueToConvert) * 60.0 * 60.0
                            + DATEPART(minute, @ValueToConvert) * 60.0
                            + DATEPART(second, @ValueToConvert) AS float) / (60.0 * 60.0 * 24.0)
           END;
END;
GO
